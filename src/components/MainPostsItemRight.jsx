                    ...
                    post.fileUrl && <div className={post.fileUrl ? 'MainPostsItemRight__image--visible' : 'MainPostsItemRight__image--invisible'
                        ...
                        {expansion === 'jpg' || expansion === 'png' ? (
                            <div className='MainPostsItemRight__image'>
                                <img className='MainPostsItemRight__img' src={`http://62.113.100.165:5002/${post?.fileUrl}`} alt='Img' />
                            </div>
                        ) :
                            <ReactPlayer className='MainPostsItemRight__video' url={`http://62.113.100.165:5002/${post?.fileUrl}`} width="100%" height="100%" controls={true} />
                        }
                    </div>
                }
